...
const mainFeaturedPost = {
  ...
  images: [
    "https://res.cloudinary.com/da4bmqkkz/image/upload/v1695971775/flat-lay-health-still-life-arrangement-with-copy-space_g0zm5q.jpg",
...
const specialtiesData = [
  {
    image:
      "https://res.cloudinary.com/da4bmqkkz/image/upload/v1698305046/pediatry_reobmn.jpg",
    title: "Pediatrics",
  },
  {
    image:
      "https://res.cloudinary.com/da4bmqkkz/image/upload/v1699939669/human-heart-with-glowing-lights-background-3d-rendering_iy1oop.jpg",
    title: "Nephrology",
  },
  {
    image:
      "https://res.cloudinary.com/da4bmqkkz/image/upload/v1699940065/doctor-touching-belly-her-patient_z0uv79.jpg",
    title: "Gynecology",
  },
  {
    image:
      "https://res.cloudinary.com/da4bmqkkz/image/upload/v1698308368/young-male-psysician-with-patient-measuring-blood-pressure_klo6sx.jpg",
    title: "General Medicine",
  },
  {
    image:
      "https://res.cloudinary.com/da4bmqkkz/image/upload/v1698308709/back-view-woman-patient-wearing-performant-eeg-headset-sitting-chair-neurological-research-laboratory-while-medical-researcher-adjusting-it-examining-nervous-system-typing-tablet_tskxi8.jpg",
    title: "Neurology",
  },
  {
    image:
      "https://res.cloudinary.com/da4bmqkkz/image/upload/v1698308973/female-psychologist-consulting-patient-desk-hospital_xfiiai.jpg",
    title: "Psychiatry",
  },
];
        ...
        <main>
          ...
          <Grid container style={{ marginTop: "50px" }}>
            <Grid item xs={12} sm={12} md={6} lg={6}>
              <div className="zoom-image-container">
                <img
                  src="https://res.cloudinary.com/da4bmqkkz/image/upload/v1698645574/work-img_ad5uzd.png"
                  className="zoom-image"
                  width="90%"
                />
              </div>
            ...
            <Grid item xs={12} sm={12} md={6} lg={6}>
              ...
              >
                <strong>
                  Bring care to your
                  <br /> home with one click
                </strong>
              </h2>
              <p style={{ color: "#808080" }}>
                MedTalk offers online medical consultations, bringing healthcare
                <br />
                professionals to your home with a single click. Access expert{" "}
                <br />
                advice, diagnosis, and treatment recommendations from the
                convenience <br />
                of your own space.
              </p>
            </Grid>
          ...
          <div
            style={{
              padding: "30px",
              backgroundImage:
                'url("https://res.cloudinary.com/da4bmqkkz/image/upload/v1698834098/v996-026_ywpsrk.jpg")',
          ...
          >
            ...
            <Grid
              container
              style={{ display: "flex", flexDirection: "row", margin: "50px" }}
            >
              <Grid item xs={12} sm={12} md={4} lg={4}>
                <Card
                  sx={{ maxWidth: 345, padding: "30px" }}
                ...
                >
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Explore a world of excellence with our platform, where you
                      can easily discover the finest online doctors.
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
          ...
          <div style={{ marginTop: "50px" }}>
            <h4 style={{ color: "#0d9eb5", textAlign: "center" }}>
